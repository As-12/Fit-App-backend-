...
user_model = api.model('user_model', {
    ...
    'target_weight': fields.Float(description='User target weight',
                                  required=False),
    'height': fields.Float(description='height in cm',
                           required=False),
    'city': fields.String(description='City', required=False),
    'state': fields.String(description='State or Country (Non-US)',
                           required=False)
})

user_patch_model = api.model('user_patch_model', {
    'target_weight': fields.Float(description='User target weight in kg',
                                  required=False),
    'height': fields.Float(description='height in cm',
                           required=False),
    'city': fields.String(description='City', required=False),
